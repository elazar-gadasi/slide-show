...
export const FROM_FAVORITES_PAGE_LINK = document.getElementById(
  "from-favorites-link"
);
export const USER_UPDATE_PAGE_LINK = document.getElementById(
  "user-update-page-link"
);
...
export const GOTO_LINK_CREATE_PIC = document.getElementById(
  "goto-create-pic-page-link"
);
export const GOTO_LINK_TO_HOME_PAGE = document.getElementById(
  "goto-to-home-page-link"
);
...
export const USER_UPDATE_PAGE = document.getElementById("user-update-page");
export const LOGIN_PAGE = document.getElementById("login-page");
export const ERROR_PAGE = document.getElementById("error404-page");
export const CONTENT_DETAILS_PAGE = document.getElementById(
  "content-details-page"
);
export const CARDS_FROM_FAVORITES_PAGE = document.getElementById(
  "cards-container-from-favorites"
);
...
/***** content details ******/
export const CONTENT_DETAILS_ID = document.getElementById("content-details-id");
export const CONTENT_DETAILS_CREATED_AT = document.getElementById(
  "content-details-createdAt"
);
export const CONTENT_DETAILS_CREATED_BY = document.getElementById(
  "content-details-createdBy"
);
export const CONTENT_DETAILS_TITEL = document.getElementById(
  "content-details-titl"
);
export const CONTENT_DETAILS_PRICE = document.getElementById(
  "content-details-price"
);
export const CONTENT_DETAILS_IMAGE = document.getElementById(
  "content-details-image-display"
);
/***** create pic form ******/
...
/***** user update Form *****/
export const FIRST_USER_UPDATE_FIELD = document.getElementById(
  "first-name-user-update-field"
);
export const FIRST_USER_UPDATE_ERROR = document.getElementById(
  "first-name-user-update-error-span"
);
export const LAST_USER_UPDATE_FIELD = document.getElementById(
  "last-name-user-update-field"
);
export const LAST_USER_UPDATE_ERROR = document.getElementById(
  "last-name-user-update-error-span"
);
export const STATE_USER_UPDATE_FIELD = document.getElementById(
  "state-user-update-field"
);
export const STATE_USER_UPDATE_ERROR = document.getElementById(
  "state-user-update-error-span"
);
export const COUNTRY_USER_UPDATE_FIELD = document.getElementById(
  "country-user-update-field"
);
export const COUNTRY_USER_UPDATE_ERROR = document.getElementById(
  "country-user-update-error-span"
);
export const CITY_USER_UPDATE_FIELD = document.getElementById(
  "city-user-update-field"
);
export const CITY_USER_UPDATE_ERROR = document.getElementById(
  "city-user-update-error-span"
);
export const STREET_USER_UPDATE_FIELD = document.getElementById(
  "street-user-update-field"
);
export const STREET_USER_UPDATE_ERROR = document.getElementById(
  "street-user-update-error-span"
);
export const HOUSE_USER_UPDATE_FIELD = document.getElementById(
  "house-user-update-field"
);
export const HOUSE_USER_UPDATE_ERROR = document.getElementById(
  "house-user-update-error-span"
);
export const ZIP_USER_UPDATE_FIELD = document.getElementById(
  "zip-user-update-field"
);
export const ZIP_USER_UPDATE_ERROR = document.getElementById(
  "zip-user-update-error-span"
);
export const EMAIL_USER_UPDATE_FIELD = document.getElementById(
  "email-user-update-field"
);
export const EMAIL_USER_UPDATE_ERROR = document.getElementById(
  "email-user-update-error-span"
);
export const PHONE_USER_UPDATE_FIELD = document.getElementById(
  "phone-user-update-field"
);
export const PHONE_USER_UPDATE_ERROR = document.getElementById(
  "phone-user-update-error-span"
);
export const PASSWORD_USER_UPDATE_FIELD = document.getElementById(
  "password-user-update-field"
);
export const PASSWORD_USER_UPDATE_ERROR = document.getElementById(
  "password-user-update-error-span"
);
export const PASSWORD_RE_ENTER_USER_UPDATE_FIELD = document.getElementById(
  "password-reenter-user-update-field"
);
export const PASSWORD_RE_ENTER_USER_UPDATE_ERROR = document.getElementById(
  "password-reenter-user-update-error-span"
);
export const BIZ_USER_UPDATE_FIELD = document.getElementById(
  "isBiz-user-update-field"
);
export const SUBMIT_BTN_USER_UPDATE = document.getElementById(
  "submit-user-update-user-btn"
);
export const CANCEL_BTN_USER_UPDATE = document.getElementById(
  "cancel-user-update-user-btn"
);
...
export const CARDS_ROW_FROM_FAVORITES = document.getElementById(
  "cards-from-favorites"
);
